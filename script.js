...
.formulario {
    ...
    border-radius: 18px;
    box-shadow: 0 6px 24px rgba(124,90,55,0.13);
...
/* Mensagem de obrigada após envio */
.form-obrigada {
    display: block;
    margin: 18px 0 0 0;
    font-weight: bold;
    ...
    border-radius: 8px;
    padding: 8px 0;
    box-shadow: 0 2px 8px rgba(124,90,55,0.08);
}

/* Dark mode e alto contraste para formulário */
...
body.alto-contraste .form-group input,
body.alto-contraste .form-group textarea {
    background: #000 !important;
    color: #ff0 !important;
    border-color: #ff0 !important;
}
body.alto-contraste .formulario .btn {
    background: #000 !important;
    color: #ff0 !important;
    border: 2px solid #ff0 !important;
}
body.alto-contraste .form-obrigada {
    background: #000 !important;
    color: #ff0 !important;
    border: 2px solid #ff0 !important;
}
...
/* Ajuste para containers e rows para evitar rolagem lateral */
.container, .row {
    width: 100%;
    max-width: 100vw;
    box-sizing: border-box;
...
/* Garante que section não ultrapasse a tela */
section {
    overflow-x: visible; /* Altere para visible */
}

/* Ajuste para imagens nunca ultrapassarem a tela */
img, iframe {
    max-width: 100vw;
    width: 100%;
    height: auto;
